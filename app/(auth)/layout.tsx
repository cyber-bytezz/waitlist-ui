          ...
          <div className="relative my-6 mr-6 hidden w-[572px] shrink-0 overflow-hidden rounded-2xl lg:block">
            ...
            <div className="absolute left-32 top-1/2 w-[500px] -translate-y-1/2">
              <div className="aspect-video w-full rounded-2xl bg-gray-900 px-5 py-3 shadow-xl transition duration-300">
                <div className="relative mb-8 flex items-center justify-between before:block before:h-[9px] before:w-[41px] before:bg-[length:16px_9px] before:[background-image:radial-gradient(circle_at_4.5px_4.5px,_theme(colors.blue.600)_4.5px,_transparent_0)] after:w-[41px]">
                ...
                <div className="font-mono text-sm text-gray-500 transition duration-300 [&_span]:opacity-0">
                  <span className="animate-[code-1_10s_infinite] text-gray-200">
                    Searching for "AI-driven solutions"...
                  </span>
                  <br />
                  <span className="animate-[code-2_10s_infinite]">
                    Fetching results from distributed neural networks...
                  </span>
                  <br />
                  <span className="animate-[code-3_10s_infinite]">
                    Generating insights with HyperFlux AI...
                  </span>
                  <br />
                  <br />
                  ...
                  <span className="animate-[code-5_10s_infinite]">
                    1. AI-Powered Analytics Tool
                  </span>
                  <br />
                  <span className="animate-[code-6_10s_infinite]">
                    2. HyperFlux Knowledge Graph
                  </span>
                  <br />
                  <span className="animate-[code-7_10s_infinite]">
                    3. Advanced Search Engine Algorithms
                  </span>
                </div>
              </div>
            </div>
